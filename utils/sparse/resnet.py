...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        if norm_layer is None:
            norm_layer = spconv.SparseBatchNorm
...
class ResNet(nn.Module):
    def __init__(
        ...
        for m in self.modules():
            if isinstance(m, (spconv.SparseConv2d, spconv.SubMConv2d)):
    ...
    def _forward_impl(self, x: Tensor | spconv.SparseConvTensor) -> Tensor:
    ...
    def forward(self, x: Tensor | spconv.SparseConvTensor) -> Tensor:
